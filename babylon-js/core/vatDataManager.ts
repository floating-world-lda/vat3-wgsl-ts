...
export default class VatDataManager {
  ...
  public static getDefaultInstanceData(instanceCount: number): Float32Array {
    ...
    for (let i = 0; i < instanceCount; i++) {
      ...
      // Forward vec3 (0, 0, -1) + roll
      initialData[baseIndex + 0] = 0.0;
      initialData[baseIndex + 1] = 0.0;
      initialData[baseIndex + 2] = -1.0;
      initialData[baseIndex + 3] = 0.0;

      // Position vec3 (0, 0, 0) + speed
      initialData[baseIndex + 4] = 0.0;
      initialData[baseIndex + 5] = 0.0;
      initialData[baseIndex + 6] = 0.0;
